      ...
      <header className="bg-white p-8">
        <div className="grid mt-16 min-h-[82vh] w-full lg:h-[54rem] md:h-[34rem] place-items-stretch bg-[url('/image/bg-hero-17.svg')] bg-center bg-contain bg-no-repeat">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              Hola, soy{" "}
              <span className="text-purple-700 leading-snug ">
                liobarrozo
              </span>{". "}
              Y construyo{" "}
              <span className="leading-snug text-purple-700">
                apps 
              </span>
            ...
            >
              Desde Mendoza, Argentina, ayudo a empresas y startups a llevar sus proyectos al siguiente nivel con soluciones web a medida.
            </Typography>
            <div className="mt-8 grid w-full place-items-start md:justify-center">
              <div className="mb-2 flex w-full flex-col gap-4 md:flex-row">
                <Input color="gray" className="p-3" placeholder="Enter your email" size="lg" />
                <Button
                    color="gray"
